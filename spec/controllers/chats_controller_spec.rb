  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved chat as @chat" do
        ...
        post :create, {:chat => { "title" => "invalid value" }}, valid_session
        assigns(:chat).should be_a_new(Chat)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested chat" do
        ...
        Chat.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => chat.to_param, :chat => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the chat as @chat" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Chat.any_instance.stub(:save).and_return(false)
        put :update, {:id => chat.to_param, :chat => { "title" => "invalid value" }}, valid_session
        assigns(:chat).should eq(chat)
      end
